...
function ResumeTailor() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log("Resume Tailor Response:", response.data);
          ...
          <div className="flex flex-col justify-between gap-5 md:flex-row md:items-center">
            ...
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500 md:text-base">
                Tailor your existing resume to a specific job description
                while preserving your real experience, skills, and achievements.
              </p>
            </div>
          ...
          <section className="mt-12">
            ...
            <div className="mb-6">
              ...
              <p className="mt-2 text-slate-500">
                Your original resume has been optimized for the target job
                while preserving your actual background.
              </p>
            </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-6 text-slate-500">
                      Review the optimized resume below or download it as
            ...
            <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              {result.professional_summary && (
                <div className="mt-8">
                  ...
                  <h3 className="border-b-2 border-slate-900 pb-2 text-sm font-extrabold uppercase tracking-wider text-slate-900">
                    Professional Summary
                  </h3>
              ...
              {result.technical_skills && (
                <div className="mt-8">
                  ...
                  <div className="mt-4 space-y-2 text-sm">
                    ...
                    {Object.entries(result.technical_skills).map(
                      ([category, skills]) => {
                        ...
                        return (
                          ...
                          >
                            <span className="min-w-fit font-bold text-slate-800">
                              {category}:
                            </span>
              ...
              {Array.isArray(result.leadership) &&
                result.leadership.length > 0 && (
                  ...
                  <div className="mt-8">
                    ...
                    <div className="mt-5 space-y-6">
                      ...
                      {result.leadership.map((role, index) => (
